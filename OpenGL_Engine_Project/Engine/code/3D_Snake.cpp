...
//	UiSystem::initialize();
//
//	std::shared_ptr<Shader> shader = Shader::load("./res/main.glslv", "./res/main.glslf");
//	if (shader == nullptr) {
...
//	}
//
//	std::shared_ptr<Shader> linesShader = Shader::load("./res/lines.glslv", "./res/lines.glslf");
